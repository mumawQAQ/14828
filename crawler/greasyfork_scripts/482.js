...
Example:  Apply with [CSS Selector](https://developer.mozilla.org/en-US/docs/Web/CSS/Attribute_selectors)
  ...
  function commonClean() {
    ...
    for (let i = 0; i < divs.length; i += 1) {
      divs[i].addEventListener('click', () => {
        ...
        deferredCleanLinks(commonParams, DELAY_TIME.normal + 500);
      }, true);
    }
