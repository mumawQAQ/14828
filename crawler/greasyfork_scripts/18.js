...
function ajax(config, callback, failback) {
    GM_xmlhttpRequest(__assign(__assign({}, config), { onload: function (r) {
            // console.log(r); // debug
...
var Swalbase = /** @class */ (function () {
    ...
    Swalbase.prototype.saveFileWork = function () {
        var _this = this;
        this.rapiduploadTask.onFinish = function () { return _this.finishView(); };
...
function getBdstoken(onSuccess, onFail) {
    ...
    }, function (statusCode) { return onFail(statusCode); });
}
/**
