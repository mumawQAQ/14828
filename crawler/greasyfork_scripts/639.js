...
// @version      1.0
// @description  Displays the number of players in Voxiom.IO by PR3DATOR
// @author       PR3DATOR
// @license MIT
// @match        *://voxiom.io/*
// @grant        none
...
(function() {
    ...
    if (localStorage.getItem('popupAnswered') === 'yes') {
        return;
    }
