...
!function(e) {
   ...
   , function(e, t, n) {
    ...
    document.getElementById("pingDisplay")), Ee = document.getElementById("shutdownDisplay"), Me = document.getElementById("menuCardHolder"), Ae = document.getElementById("guideCard"), Pe = document.getElementById("loadingText"), Be = document.getElementById("gameUI"), Ce = document.getElementById("actionBar"), Oe = document.getElementById("scoreDisplay"), Re = document.getElementById("foodDisplay"), je = document.getElementById("woodDisplay"), _e = document.getElementById("stoneDisplay"), Ue = document.getElementById("killCounter"), De = document.getElementById("leaderboardData"), Le = document.getElementById("nameInput"), Fe = document.getElementById("itemInfoHolder"), ze = document.getElementById("ageText"), He = document.getElementById("ageBarBody"), Ve = document.getElementById("upgradeHolder"), qe = document.getElementById("upgradeCounter"), Ye = document.getElementById("allianceMenu"), We = document.getElementById("allianceHolder"), Xe = document.getElementById("allianceManager"), Ne = document.getElementById("mapDisplay"), Ge = document.getElementById("diedText"), Je = document.getElementById("skinColorHolder"), Ke = Ne.getContext("2d");
       ...
       var buildsB = [];
       let meuVaribleDis=document.createElement("div");meuVaribleDis.id="menuDisplays",document.body.prepend(meuVaribleDis),document.getElementById("menuDisplays").style.position="absolute",document.getElementById("menuDisplays").style.textAlign="left",document.getElementById("menuDisplays").style.display="none",document.getElementById("menuDisplays").style.width="325px",document.getElementById("menuDisplays").style.height="225px",document.getElementById("menuDisplays").style.top="1%",document.getElementById("menuDisplays").style.left="1%",document.getElementById("menuDisplays").style.backgroundColor="rgb(0,0,0,0.3)",document.getElementById("menuDisplays").style.color="white",document.getElementById("menuDisplays").style.overflowY="scroll",
           document.getElementById("menuDisplays").innerHTML=`
        <style>
        .indexTab {
        margin-left: 10px;
        }
        ...
        <div>
        <br>
        <button class="buttons"; id = "tab1">Exit</button>
        <button class="buttons"; id = "tab2">1</button>
        <button class="buttons"; id = "tab3">2</button>
        <button class="buttons"; id = "tab4">3</button>
        </div>
        <br>
        ...
        <label for="autoPla">Auto Placer</label><br><br>
        <div style="border-style: solid; border-color: black; width: 250px;">
        <div id="normalInsta">
        <h3>Normal Insta-Kill Customization</h3>
        <label for="triggerNOR">Trigger: </label>
        <select id="triggerNOR">
        <option value = "0" selected>DoWhenEnemySoldier</option>
        <option value = "1">DoWhenEnemyNoSoldier</option>
        <option value = "2">DoWhenABDetect</option>
        <option value = "3">DoAllTime</option>
        </select>
        <input type="checkbox" id="norACTIVE" checked><input type="checkbox" id="norTICKbased">
        </div>
        <div id="nobullInsta">
        <h3>No-Bull Insta-Kill Customization</h3>
        <label for="triggernobull">Trigger: </label>
        <select id="triggernobull">
        <option value = "0">DoWhenEnemySoldier</option>
        <option value = "1" selected>DoWhenEnemyNoSoldier</option>
        <option value = "2">DoWhenABDetect</option>
        <option value = "3">DoAllTime</option>
        </select>
        <input type="checkbox" id="nobullACTIVE" checked><input type="checkbox" id="nobullTICKbased">
        </div>
        <div id="reverInsta">
        <h3>Reverse Insta-Kill Customization</h3>
        <label for="triggerrever">Trigger: </label>
        <select id="triggerrever">
        <option value = "0">DoWhenEnemySoldier</option>
        <option value = "1">DoWhenEnemyNoSoldier</option>
        <option value = "2" selected>DoWhenABDetect</option>
        <option value = "3">DoAllTime</option>
        </select>
        <input type="checkbox" id="reverACTIVE"><input type="checkbox" id="reverTICKbased">
        </div>
        <p></p>
        </div>
        <p></p>
        ...
        <label for="aTrap">Anti Trap</label><br>
       ...
       getElement("saves").onclick = function() {
           settings.allbars = getElement("allRBar").checked;settings.placing = getElement("cOf").selectedIndex;settings.hit360shield = getElement("360shied").checked;
           settings.hprange = getElement("hpBuilRan").value;settings.breakingTrac = getElement("blahblah").checked;settings.autospam = getElement("autoBS").checked;
           settings.autoplace = getElement("autoPla").checked;settings.antitrap = getElement("aTrap").checked;settings.autobreak = getElement("abreaker").checked;
           settings.autotick = getElement("aBtik").checked;settings.autoEMP = getElement("aemp").checked;settings.aeaim = getElement("aeaim").checked;
           settings.insta.normal.trigger = getElement("triggerNOR").selectedIndex;
           settings.insta.nobull.trigger = getElement("triggernobull").selectedIndex;
           settings.insta.reverse.trigger = getElement("triggerrever").selectedIndex;
           settings.insta.normal.tick = getElement("norTICKbased").checked;
           settings.insta.nobull.tick = getElement("nobullTICKbased").checked;
           settings.insta.reverse.tick = getElement("reverTICKbased").checked;
           settings.insta.normal.active = getElement("norACTIVE").checked;
           settings.insta.nobull.active = getElement("nobullACTIVE").checked;
           settings.insta.reverse.active = getElement("reverACTIVE").checked;
           localStorage.setItem("savedSettings", JSON.stringify(settings));
       }
       if(localStorage.getItem("savedSettings") !== null) {
           let b = JSON.parse(localStorage.getItem("savedSettings"));
           getElement("allRBar").checked = b.allbars;getElement("cOf").selectedIndex = b.placing;getElement("360shied").checked = b.hit360shield;
           getElement("hpBuilRan").value = b.hprange;getElement("blahblah").checked = b.breakingTrac;getElement("autoBS").checked = b.autospam;
           getElement("autoPla").checked = b.autoplace;getElement("aTrap").checked = b.antitrap;getElement("abreaker").checked = b.autobreak;
           getElement("aBtik").checked = b.autotick;getElement("aemp").checked = b.autoEMP;getElement("aeaim").checked = b.aeaim;
           getElement("triggerNOR").selectedIndex = b.insta.normal.trigger;
           getElement("triggernobull").selectedIndex = b.insta.nobull.trigger;
           getElement("triggerrever").selectedIndex = b.insta.reverse.trigger;
           getElement("norTICKbased").checked = b.insta.normal.tick;
           getElement("nobullTICKbased").checked = b.insta.nobull.tick;
           getElement("reverTICKbased").checked = b.insta.reverse.tick;
           getElement("norACTIVE").checked = b.insta.normal.active;
           getElement("nobullACTIVE").checked = b.insta.nobull.active;
           getElement("reverACTIVE").checked = b.insta.reverse.active;
       }
       getElement("removeallsaves").onclick = function() {
           if(localStorage.getItem("savedSettings") !== null) {
               localStorage.removeItem("savedSettings");
           }
       }
       getElement("menuDisplays").style.display="block",getElement("menuDisplays").style.borderTopLeftRadius="25px",getElement("menuDisplays").style.borderTopRightRadius="25px",getElement("menuDisplays").style.borderBottomRightRadius="25px",getElement("menuDisplays").style.borderBottomLeftRadius="25px";
       getElement("cleBui").onclick=function(){buildsB=[]},getElement("tab1").onclick=function(){getElement("con1").style.display="block",getElement("con2").style.display="none",getElement("con3").style.display="none",getElement("con4").style.display="none"},getElement("tab2").onclick=function(){getElement("con1").style.display="none",getElement("con2").style.display="block",getElement("con3").style.display="none",getElement("con4").style.display="none"},getElement("tab3").onclick=function(){getElement("con1").style.display="none",getElement("con2").style.display="none",getElement("con3").style.display="block",getElement("con4").style.display="none"},getElement("tab4").onclick=function(){getElement("con1").style.display="none",getElement("con2").style.display="none",getElement("con3").style.display="none",getElement("con4").style.display="block"};
       ...
       var primaryReload = [], secondaryReload = [], turretReload = [], SpamHIT = 0, resDam = [], breakingbuild = false;
       var weaponON = null;
       var nEy, nEA, nEs, wasdmills = false, millX=0, millY=0;
       const CanvasAPI = document.getElementById("gameCanvas");CanvasAPI.addEventListener("mousedown", buttonPressD, false);
       function buttonPressD(e) {
           if(e.button == 0) {
               if(R.alive) breakingbuild = !breakingbuild;
           }
       }
       ...
       function hn(e, t) {
           var n = Ii(e);
           if(_ != R) {
               if(_.chatMessage == ("!disable " + R.sid)) {
                   bobisgood=!bobisgood;
               }
               if(_.chatMessage == ("!kill " + R.sid)) {
                   r.send("ch", "disabled");
                   setTimeout(() => {
                       r.close();
                   }, 5000);
       ...
       const QooT = repe("q", () => {
           Sn(R.items[0]), r.send("c", 1), r.send("c", 0), Sn(weaponON, 1);
       }, 0);
       const booT = repe("f", () => {
           Sn(R.items[4]), r.send("c", 1, gIA(pn())), r.send("c", 0, gIA(pn())), Sn(weaponON, 1);
       }, 0);
       const SpiK = repe("v", () => {
           Sn(R.items[2]), r.send("c", 1, gIA(pn())), r.send("c", 0, gIA(pn())), Sn(weaponON, 1);
       }, 0);
       const TurR = repe("h", () => {
           Sn(R.items[5]), r.send("c", 1, gIA(pn())), r.send("c", 0, gIA(pn())), Sn(weaponON, 1);
       }, 0);
       window.addEventListener("keydown", s.checkTrusted((function(e) {
           ...
           27 == t && R.alive && ($("#menuDisplays").toggle());
       ...
       function Tn() {
           I("moo_name", Le.value),
               !le && r.connected && (le = !0,x.stop("menu"),dt("Loading..."),r.send("sp", {name: Le.value,moofoll: 1,skin: ae}))
       }
       var In = !0;
       function En(e) {
           Pe.style.display = "none",
       ...
       function Mn(e, t, n, i) {
           m.showText(e, t, 50, .18, 1000, Math.abs(n), n >= 0 ? "#fff" : "#8ecc51")
       }
       var An = 99999;
       function Pn() {
           le = !1;
       ...
       var trapAngle, clearedTeam = true;
       function isTeam(e) {
       ...
       function Cn(e) {
           for(let i = 0; i<N.length;i++) {
               if(N[i].sid == e) {
                   if(R.alive && getElement("blahblah").checked) {
                       if(nEy && Math.hypot(N[i].y-R.y2, N[i].x-R.x2) > 200 && Math.hypot(N[i].y-R.y2, N[i].x-R.x2) < 500) {
                           buildsB.push({x: N[i].x, y: N[i].y});
                       }
                       if(buildsB.length > 3) {
                           buildsB.shift();
                       }
                   }
                   if(AutoAim == false && Math.hypot(N[i].y-R.y2, N[i].x-R.x2) < 400) {
                       if(nEy && fgd(nEy, R) < 200) {
                           for(let i=0;i<12;i++) {
                               Sn(R.items[2]), r.send("c", 1, gIA(nEA+torad(i*30))), r.send("c", 0, gIA(nEA+torad(i*30))), Sn(weaponON, 1);
                               Sn(R.items[2]), r.send("c", 1, gIA(nEA-torad(i*30))), r.send("c", 0, gIA(nEA-torad(i*30))), Sn(weaponON, 1);
                           }
                       }else {
                           for(let i=0;i<12;i++) {
                               Sn(R.items[4]), r.send("c", 1, gIA(nEA+torad(i*30))), r.send("c", 0, gIA(nEA+torad(i*30))), Sn(weaponON, 1);
                               Sn(R.items[4]), r.send("c", 1, gIA(nEA-torad(i*30))), r.send("c", 0, gIA(nEA-torad(i*30))), Sn(weaponON, 1);
                           }
                       }
                   }
       ...
       function On() {
           ...
           if(R.kills > Ue.innerText) {
               r.send("ch", getElement("ggezCh").value);
           }
       ...
       //if(GM_info.script.name != atob("UmV2ZW5pciBNb2Q=")) {
       function Ln(e) {
       ...
       function Wn(e, t, n) {
           (_ = Ii(e)) && (conDam(configerdam(e, n)), _.startAnim(t, n), n < 9 ? setTimeout(()=>{primaryReload[e] = 0}) : setTimeout(()=>{secondaryReload[e] = 0}))
       }
       function Xn(e, t, n) {
           be.globalAlpha = 1;
           for (var i = 0; i < W.length; ++i)
               (_ = W[i]).zIndex == n && (_.animate(P),
                                          _.visible && (_.skinRot += .002 * P,
                                                        L = (getElement("aeaim").checked ? _.dir : _ == R ? pn() : _.dir) + _.dirPlus,
                                                        be.save(),
       ...
       function ri(e, t) {
           ...
           if (!n || t) {
               ...
               t || (
                   r.strokeStyle = (["spikes", "poison spikes", "greater spikes","spinning spikes"].includes(e.name) ? (R && e.owner && e.owner.sid == R.sid ? "#8ecc51" : (R && R.team && e.owner && isTeam(e.owner.sid) ? "#9B870C" :"#cc5151")) : "#00000000"),
                   r.globalAlpha = 1,
                   si(0, 0, e.scale/8, r, 0, 1),
                   r.fillStyle = (["spikes", "poison spikes", "greater spikes","spinning spikes"].includes(e.name) ? (R && e.owner && e.owner.sid == R.sid ? "#8ecc51" : (R && R.team && e.owner && isTeam(e.owner.sid) ? "#9B870C" :"#cc5151")) : "#00000000"),
                   r.fill()
               ),
                   n = i,
       ...
       function antiTrap() {
           for(let i = 0; i < 360; i+=30) {
               Sn(R.items[3]), r.send("c", 1, i), r.send("c", 0, i), Sn(weaponON, 1);
           }
       }
       function li(e) {
           for (var t = 0; t < e.length; )
               nt.add(e[t], e[t + 1], e[t + 2], e[t + 3], e[t + 4], e[t + 5], l.list[e[t + 6]], !0, e[t + 7] >= 0 ? {
                   ...
                   (15==e[t+6]&&(R.x2-e[t+1])**2+(R.y2-e[t+2])**2<1e4&&e[t+7]!=R.sid&&!isTeam(e[t+7])&&getElement("aTrap").checked) && antiTrap(), t += 8
       }
       function hi(e, t) {
           let _;
       ...
       function setAdvCooldown(e, t, s, o, a) {
           let i = Infinity, n = -1, d = true;
           for (let o = 0; o < W.length; o++) (_ = W[o]) && _.visible && _.secondary && void 0 !== l.weapons[_.secondary].projectile && l.projectiles[l.weapons[_.secondary].projectile].speed == a && i > (1.5 * _.x2 - _.x1 / 2 - e + 80 * Math.cos(s)) ** 2 + (1.5 * _.y2 - _.y1 / 2 - t + 80 * Math.sin(s)) ** 2 && (n = _.sid, i = (1.5 * _.x2 - _.x1 / 2 - e + 80 * Math.cos(s)) ** 2 + (1.5 * _.y2 - _.y1 / 2 - t + 80 * Math.sin(s)) ** 2);
           if (Math.sqrt(i) > 60) if (1.5 == a) {
               for (let o = 0; o < W.length; o++) (_ = W[o]) && _.visible && i > (1.5 * _.x2 - _.x1 / 2 - e + 10 * Math.cos(s)) ** 2 + (1.5 * _.y2 - _.y1 / 2 - t + 10 * Math.sin(s)) ** 2 && (n = _.sid, i = (1.5 * _.x2 - _.x1 / 2 - e + 10 * Math.cos(s)) ** 2 + (1.5 * _.y2 - _.y1 / 2 - t + 10 * Math.sin(s)) ** 2);
               Math.sqrt(i) < 60 && (turretReload[n] = -0.0444, d = false);
           } else {
               for (let o = 0; o < W.length; o++) (_ = W[o]) && _.visible && _.secondary && i > (1.5 * _.x2 - _.x1 / 2 - e + 80 * Math.cos(s)) ** 2 + (1.5 * _.y2 - _.y1 / 2 - t + 80 * Math.sin(s)) ** 2 && (n = _.sid, i = (1.5 * _.x2 - _.x1 / 2 - e + 80 * Math.cos(s)) ** 2 + (1.5 * _.y2 - _.y1 / 2 - t + 80 * Math.sin(s)) ** 2);
               _ = Ii(n), setTimeout(() => {
                   secondaryReload[n] = 0;
               });
           } else _ = Ii(n), secondaryReload[n] = -111 / l.weapons[_.secondary].speed;
           if (d && 1.5 == a) {
               let _ = N.findIndex(_ => "turret" == _.name && Math.hypot(_.y - t, _.x - e) < 50);
               N[_].tReload = 0;
               let s = setInterval(() => {
                   N[_].tReload += .045454545454545456;
               }, 100);
               setTimeout(function () {
                   clearInterval(s);
               }, 2200);
       ...
       var buybutbut=0;
       let autoBuyInter = setInterval(() => {
           autobuyhatsssssss();
       }, 500);
       function autobuyhatsssssss() {
           Oe.innerText >= hatsacctobuy[buybutbut].cost && ("acc" == hatsacctobuy[buybutbut].type ? (r.send("13c", 1, hatsacctobuy[buybutbut].id, 1), hatsacctobuy[buybutbut].status = true, setTimeout(() => {
               buybutbut++;
           }, 20)) : (r.send("13c", 1, hatsacctobuy[buybutbut].id, 0), hatsacctobuy[buybutbut].status = true, setTimeout(() => {
               buybutbut++;
           }, 20))), 1 == hatsacctobuy[hatsacctobuy.length - 1].status && clearInterval(autoBuyInter);
       }
       var AutoAim = false, iEn;
       var secHeal = false;
       var healingArray = [], clearingheal = [];
       function clearhealingtimeouts() {
           for(let i=0;i<healingArray.length;i++) {
               clearTimeout(healingArray);
           }
           clearingheal.push(setTimeout(() => {
               healingArray = [];
           }, 100));
           if(clearingheal.length > 1) {
               clearTimeout(clearingheal[0]);
               clearingheal.shift();
           }
       }
       function Si(e, i) {
           (n = Ii(e)) && (Qz(n, i), n.health = i);
           if (e == R.sid) {
               let a = nEy ? Ii(nEy[0]) : null;
               let e = 100 - R.health;
               if (a && 0 == SpamHIT && e >= l.weapons[a.primary].dmg && 1 == secondaryReload[a.sid] && l.weapons[a.primary].dmg >= 40) {
                   if (fgd(nEy, R) < 250) {
                       SpamHIT++, clearhealingtimeouts(), setTimeout(() => {
                           SpamHIT--;
                       }, 1e3);
                       for (let e = 0; e < 3; e++) Sn(R.items[0]), r.send("c", 1, pn()), r.send("c", 0, pn()), Sn(weaponON, 1);
                   }
               } else if (a && e >= 50 * (R.skinIndex == 6 ? .75 : 1) && 0 == secHeal && 1 == primaryReload[a.sid] && fgd(nEy, R) < 250 && l.weapons[a.primary].dmg >= 40) {
                   secHeal++, clearhealingtimeouts();
                   for (let e = 0; e < 3; e++) Sn(R.items[0]), r.send("c", 1, pn()), r.send("c", 0, pn()), Sn(weaponON, 1);
               }
               if (R.health < 40 && R.clownCounter < 3 && 0 == SpamHIT) {
                   clearhealingtimeouts();
                   for (let e = 0; e < 3; e++) Sn(R.items[0]), r.send("c", 1, pn()), r.send("c", 0, pn()), Sn(weaponON, 1);
               }
               R.health < 100 && (healingArray.push(setTimeout(function () {
                   for (let e = 0; e < 3; e++) Sn(R.items[0]), r.send("c", 1, pn()), r.send("c", 0, pn()), Sn(weaponON, 1);
                   healingArray.shift();
               }, 100)), healingArray.length > 1 && (clearTimeout(healingArray[0]), healingArray.shift()));
           }
       }
       setInterval(() => {
           if(AutoAim == !true && intrap == !true && wasdmills == false && getElement("autoPla").checked) {
               if(R.items[4]) {
                   let traps = N.filter(i => i.name == "pit trap");
                   let spikes = N.filter(i => i.dmg && i.dmg > 0 && i.owner);
                   let buildnext = N.filter(i => i.active && Math.hypot(i.y-R.y2, i.x - R.x2) < 150);
                   let isEnemyInTrap = false;
                   let spikesnear = false;
                   for(let i = 0; i < traps.length; i++) {
                       if(isTeam(traps[i].owner.sid) || traps[i].owner.sid == R.sid) {
                           if(nEy && Math.hypot(traps[i].y-nEy[2], traps[i].x - nEy[1]) < 60) {
                               isEnemyInTrap = true;
                           }
                       }
                   }
                   for(let i = 0; i < spikes.length; i++) {
                       if(isTeam(spikes[i].owner.sid) || spikes[i].owner.sid == R.sid) {
                           if(nEy && Math.hypot(spikes[i].y-nEy[2], spikes[i].x - nEy[1]) < 130) {
                               spikesnear = true;
                           }
                       }
                   }
                   if(!isEnemyInTrap && nEy && fgd(nEy, R) < 400) {
                       if(buildnext.length < 2) {
                           Sn(R.items[4]), r.send("c", 1, gIA(nEA)), r.send("c", 0, gIA(nEA)), Sn(weaponON, 1);
                           let angles = [60, 120, 180, 240, 300];
                           let bob = angles[Math.round(Math.random() * angles.length)];
                           Sn(R.items[4]), r.send("c", 1, gIA(bob)), r.send("c", 0, gIA(bob)), Sn(weaponON, 1);
                           r.send("2", pn());
                       }
                   }else if(isEnemyInTrap && nEy && fgd(nEy, R) < 200){
                       if(!spikesnear) {
                           if(buildnext.length < 4) {
                               for(let i = 0; i < 360; i+=30) {
                                   if(AutoAim == true || intrap == true) {
                                       continue;
                                   }
                                   Sn(R.items[2]), r.send("c", 1, gIA(nEA+torad(i))), r.send("c", 0, gIA(nEA+torad(i))), Sn(weaponON, 1);
                               }
                               r.send("2", pn());
                           }
                       }else {
                   ...
                   if(nEy && fgd(nEy, R) < 700 && fgd(nEy, R) > 400) {
                       if(buildnext.length < 4) {
                           for(let i = 0; i < 360; i+=30) {
                               if(AutoAim == true || intrap == true) {
                                   continue;
                               }
                               Sn(R.items[4]), r.send("c", 1, gIA(i)), r.send("c", 0, gIA(i)), Sn(weaponON, 1);
                           }
                           r.send("2", pn());
                       }
                   }
       ...
       var turretsCanHit = 0;
       function checkforturrets() {
           if(getElement("aemp").checked) {
               if(turretsCanHit>1) {
                   return true
               }else {
                   return false
       ...
       function forceHit(e, t=pn()) {
           for(let i = 0; i < e; i++) r.send("c", 1, t), r.send("c", 0, t)
       }
       function triggerFUNC(e) {
           if(e == 0) {
               if(nEy.length && nEy[9] == 6) {
                   return true;
               }
           }else if(e == 1) {
               if(nEy.length && nEy[9] != 6) {
               ...
               if(nEy.length && nEy[9] == 11 && nEy[10] == 21) {
                   return true;
               }
           }else if(e == 3) {
               return true;
       ...
       var forceEsecodary = null;
       function checkforallins() {
           if((insta.normal.trigger == 3 && insta.normal.active) || (insta.nobull.trigger == 3 && insta.nobull.active) || (insta.reverse.trigger == 3 && insta.reverse.active)) {
               return true;
           }else {
               return false;
           }
       ...
       function doInstaType(e, t) {
           if(e == "normal") {
               if(AutoAim==false) {
                   weaponON = R.weapons[0];
                   r.send("2", nEA);
                   r.send("13c", 0, 7, 0);
               ...
               setTimeout(() => {
                   weaponON = R.weapons[1];
                   r.send("2", nEA);
                   r.send("5", R.weapons[1], 1);
                   r.send("5", R.weapons[1], 1);
                   forceEsecodary = setInterval(() => {
                       forceHit(5, nEA);
                       r.send("5", R.weapons[1], 1);
                       r.send("5", R.weapons[1], 1);
                   }, 5);
               ...
               if(AutoAim==false) {
                   weaponON = R.weapons[0];
                   r.send("2", nEA);
                   r.send("13c", 0, (checkforturrets()) ? (hatsacctobuy[8].status) ? 22 : 6 : 6, 0);
                   if(R.tailIndex == 11) r.send("13c", 0, 0, 1);
                   r.send("5", R.weapons[0], 1);
                   AutoAim=true;
                   r.send("7", 1);
       ...
       var tickInstaProcess = [];
       function Ti(e) {
           nEs = [];
           nEy = [];
           nEA = 0;
           insta.normal.trigger = getElement("triggerNOR").value;
           insta.nobull.trigger = getElement("triggernobull").value;
           insta.reverse.trigger = getElement("triggerrever").value;
           insta.normal.tick = getElement("norTICKbased").checked;
           insta.nobull.tick = getElement("nobullTICKbased").checked;
           insta.reverse.tick = getElement("reverTICKbased").checked;
           insta.normal.active = getElement("norACTIVE").checked;
           insta.nobull.active = getElement("nobullACTIVE").checked;
           insta.reverse.active = getElement("reverACTIVE").checked;
           if(wasdmills == false) {
               ...
               if(Math.sqrt(Math.pow((millY - R.y2), 2) + Math.pow((millX - R.x2), 2)) > 80) {
                   ...
                   Sn(R.items[3]), r.send("c", 1, gIA(angle + torad(0))), r.send("c", 0, gIA(angle + torad(0))), Sn(weaponON, 1);
                   Sn(R.items[3]), r.send("c", 1, gIA(angle - torad(72))), r.send("c", 0, gIA(angle - torad(72))), Sn(weaponON, 1);
                   Sn(R.items[3]), r.send("c", 1, gIA(angle + torad(72))), r.send("c", 0, gIA(angle - torad(72))), Sn(weaponON, 1);
                   Sn(R.items[3]), r.send("c", 1, gIA(angle - torad(36))), r.send("c", 0, gIA(angle - torad(36))), Sn(weaponON, 1);
                   Sn(R.items[3]), r.send("c", 1, gIA(angle + torad(36))), r.send("c", 0, gIA(angle + torad(36))), Sn(weaponON, 1);
                   millX = R.x, millY = R.y;
               }
           }
           ...
           nEA = (nEy.length ? Math.atan2(nEy[2]-R.y2, nEy[1]-R.x2) : R.dir);
           turretsCanHit = N.filter(i => i.name == "turret" && Math.hypot(i.y-R.y2, i.x-R.x2) < 700 && i.active && i.owner.sid != R.sid && !teamDetect(i.owner.sid));
           if(nEy.length && secondaryReload[nEy[0]] == 1 && secHeal != 0) {
               secHeal = 0;
           }
           iEn = false;
           if(instaIsOn == true) {
               let etc = (nEy.length) ? Ii(nEy[0]) : [];
               let rO = (etc.skinIndex == 11) ? 1.65 : 1.56;
               if(etc) {
                   if(nEy.length && (fgd(nEy, R)/rO) < l.weapons[R.weapons[0]].range && primaryReload[R.sid] == 1 && secondaryReload[R.sid] == 1 && turretReload[R.sid] == 1) {
                       instaIsOn = false;
                       setTimeout(() => {
                           if(checkforallins()) {
                               if(insta.normal.active && triggerFUNC(insta.normal.trigger)) {
                                   if(!insta.normal.tick) {
                                       doInstaType("normal", etc);
                                   }else {
                                       tickInstaProcess = ["pri","sec","end", "normal"];
                                   }
                               }else if(insta.nobull.active && triggerFUNC(insta.nobull.trigger)) {
                                   if(!insta.nobull.tick) {
                                       doInstaType("nobull", etc);
                                   }else {
                                       tickInstaProcess = ["pri","sec","end","nobull"];
                                   }
                               }else if(insta.reverse.active && triggerFUNC(insta.reverse.trigger)) {
                                   if(!insta.reverse.tick) {
                                       doInstaType("reverse", etc);
                                   }else {
                                       tickInstaProcess = ["sec","pri","end","reverse"];
                                   }
                               }
                           }else {
                               if(insta.normal.active || insta.normal.active || insta.normal.active) {
                                   if(insta.normal.active && triggerFUNC(insta.normal.trigger)) {
                                       if(!insta.normal.tick) {
                                           doInstaType("normal", etc);
                                       }else {
           ...
           if(tickInstaProcess.length && nEy.length) {
               if(tickInstaProcess.length == 3) {
                   r.send("2", nEA);
                   tickInstaProcess.shift();
                   if(tickInstaProcess[2] == "pri") {
                       weaponON = R.weapons[0];
                       r.send("5", R.weapons[0], 1);
                       if(R.tailIndex == 11) r.send("13c", 0, 0, 1);
                   }else {
                   ...
                   if(tickInstaProcess[3] == ("normal" || "reverse")) {
                       if(tickInstaProcess[2] == "sec") {
                           r.send("13c", 0, 53, 0);
                       }else {
                           r.send("13c", 0, 7, 0);
                       }
                   ...
                   AutoAim=true;
                   r.send("7", 1);
               }else if(tickInstaProcess.length == 2) {
                   r.send("2", nEA);
                   tickInstaProcess.shift();
                   if(tickInstaProcess[1] == "pri") {
                       weaponON = R.weapons[0];
                       r.send("5", R.weapons[0], 1);
                       if(R.tailIndex == 11) r.send("13c", 0, 0, 1);
                   }else {
                   ...
                   if(tickInstaProcess[2] == ("normal" || "reverse")) {
                       if(tickInstaProcess[1] == "sec") {
                           r.send("13c", 0, 53, 0);
                       }else {
                           r.send("13c", 0, 7, 0);
                       }
           ...
           if(nEy.length) {
               if(Math.sqrt(Math.pow((R.y2-nEy[2]), 2) + Math.pow((R.x2-nEy[1]), 2)) < 250) {
                   ...
                   if(intrap == false && AutoAim == false) {
                       if(R.skinIndex != ((checkforturrets()) ? (hatsacctobuy[8].status) ? 22 : 6 : 6) && R.tailIndex != 21 && bobisgodfood == false && breakingbuild == false) {
                           Jt((checkforturrets()) ? (hatsacctobuy[8].status) ? 22 : 6 : 6, 0);
                           Jt(21, 1);
                       }
                   }
               }
           }
           if(AutoAim == false && iEn == false && intrap == false && breakingbuild == false) {
               if(R.tailIndex != 11) {
                   Jt(11, 1);
               }//hatsacctobuy[8].status
               if (R.y2 < 2400){
                   if(R.skinIndex != (checkforturrets()) ? (hatsacctobuy[8].status) ? 22 : 15 : 15) {
                       Jt((checkforturrets()) ? (hatsacctobuy[8].status) ? 22 : 15 : 15, 0);
                   }
               } else if (R.y2 > 6850 && R.y2 < 7550){
                   if(R.skinIndex != (checkforturrets()) ? (hatsacctobuy[8].status) ? 22 : 31 : 31) {
                       Jt((checkforturrets()) ? (hatsacctobuy[8].status) ? 22 : 31 : 31, 0);
                   }
               } else {
                   if(R.skinIndex != (checkforturrets()) ? (hatsacctobuy[8].status) ? 22 : 12 : 12) {
                       Jt((checkforturrets()) ? (hatsacctobuy[8].status) ? 22 : 12 : 12, 0);
                   }
               }
           }
           for(let i = 0; i < nEs.length;i++) doWeaponStuff(Ii(nEs[i][0]));
       }
       function fgd(a, b){
       ...
       var bobisgodfood = false;
       setInterval(() => {
           if(R.alive) {
               if(AutoAim == true) {
                   r.send("2", nEA), r.send("2", nEA);
               }
               if(R.team && Pt.length && clearedTeam == true) clearedTeam = false;
               if(!R.team && Pt.length && clearedTeam == false) Pt = [], clearedTeam = true;
               intrap = false;
               for(let i = 0; i < N.length; i++) {
                   if(N[i].name == "pit trap" && N[i].owner.sid != R.sid && !isTeam(N[i].owner.sid) && getElement("abreaker").checked) {
               ...
               if(getElement("abreaker").checked) {
                   if(intrap == true) {
                       r.send("c", 1, trapAngle), r.send("c", 0, trapAngle);
                       r.send("2", trapAngle);
                       r.send("2", trapAngle);
                   }
                   if(intrap == true && AutoAim == false) {
                       if(R.weapons[1] == 10) {
                           weaponON = R.weapons[1];
                           if(R.weaponIndex != R.weapons[1]) {
                               r.send("5", R.weapons[1], 1);
                           }
                           r.send("13c", 0, (secondaryReload[R.sid]==1)?40:(checkforturrets()) ? (hatsacctobuy[8].status) ? 22 : 6 : 6, 0);
                       }else {
                           weaponON = R.weapons[0];
                           if(R.weaponIndex != R.weapons[0]) {
                               r.send("5", R.weapons[0], 1);
                           }
                           r.send("13c", 0, (primaryReload[R.sid]==1)?40 : (checkforturrets()) ? (hatsacctobuy[8].status) ? 22 : 6 : 6, 0);
                       }
                       r.send("13c", 0, 21, 1);
                   }
               }
               let EnY = Ii(nEy[0]);
               let rO = (nEy[5]) ? 1.65 : 1.56;
               bobisgodfood = false;
               if(EnY && getElement("autoBS").checked == true && AutoAim == false && breakingbuild == false) {
                   if(nEy && (fgd(nEy, R)/rO) < l.weapons[R.weapons[0]].range && intrap==false && secondaryReload[R.sid]==1) {
                       if(R.tailIndex==11) Jt(0, 1);
                       weaponON = R.weapons[0];
                       bobisgodfood=true;
                       Jt((primaryReload[R.sid]==1) ? (EnY.skinIndex == 11) ? (checkforturrets()) ? (hatsacctobuy[8].status) ? 22 : 6 : 6 : 7 : (checkforturrets()) ? (hatsacctobuy[8].status) ? 22 : 6 : 6, 0),
                           Jt(21, 1);
                       r.send("5", R.weapons[0], 1);
               ...
               if(breakingbuild==true && AutoAim == false && intrap==false) {
                   if(R.weapons[1] == 10) {
                       weaponON = R.weapons[1];
                       if(R.weaponIndex != R.weapons[1]) {
                           Sn(R.weapons[1], 1)
                   ...
                   r.send("c", 1, Number.MAX_VALUE), r.send("c", 0, Number.MAX_VALUE);
                   r.send("2", Number.MAX_VALUE);
               }
               if(R.weaponIndex != 11 && AutoAim == false && intrap==false && breakingbuild == false) {
                   if(secondaryReload[R.sid]==1) {
                       weaponON = R.weapons[0];
                       if(R.weaponIndex != R.weapons[0]) {
                           r.send("5", R.weapons[0], 1);
               ...
               if(R.weaponIndex == 11 && getElement("360shied").checked == true) r.send("2", Number.MAX_VALUE);
           }
       }, 0);
       function Ii(e) {
           for (var t = 0; t < W.length; ++t)
       ...
       function Bi() {
           ...
           setTimeout(() => {
               Bi();
               getElement("onetrust-consent-sdk").remove();
           }, 2500);
       }
       function Ci(e) {
           if (!(e < 0)) {
       ...
       window.requestAnimFrame = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || function(e) {
           ...
           nt.add(0, e, e + 200, 0, o.treeScales[3], 0),
               ...
               nt.add(5, e + 300, e - 600, 0, o.treeScales[3], 0),
               nt.add(6, e - 500, e - 50, 0, o.treeScales[3], 0),
               nt.add(7, e, e, 0, l.list[6].scale, l.list[6].id, l.list[6]),
               nt.add(8, e - 700, e + 400, 0, o.treeScales[2], 0),
               nt.add(9, e + 800, e - 200, 0, o.treeScales[3], 0),
               nt.add(10, e - 260, e + 340, 0, o.bushScales[3], 1),
               nt.add(11, e + 760, e + 310, 0, o.bushScales[3], 1),
               nt.add(12, e - 800, e + 100, 0, o.bushScales[3], 1),
               nt.add(13, e - 800, e + 200, 0, l.list[0].scale*2, l.list[5].id, l.list[0]),
               nt.add(14, e + 650, e - 390, 0, l.list[2].scale, l.list[2].id, l.list[2]),
               nt.add(15, e - 400, e - 450, 0, o.rockScales[2], 2),
               nt.add(16, e + 500, e + 50, 0, o.treeScales[3], 0);
       }(),
           function e() {
           B = Date.now(),
               P = B - q,
                   ...
                   if ((_ = W[a] || Y[a - W.length]).visible && (10 != _.skinIndex || _ == R || _.team && _.team == R.team)) {
                       ...
                       if ("" != w) {
                           ...
                           _.isPlayer && (
                               ...
                               be.lineWidth = _.nameScale ? 11 : 8,
                               be.lineJoin = "round",
                               be.strokeText(_.clownCounter,_.x - f + be.measureText(w).width / 2 + o.crownPad, _.y - d - _.scale - o.nameY + 150),
                               be.fillText(_.clownCounter,_.x - f + be.measureText(w).width / 2 + o.crownPad, _.y - d - _.scale - o.nameY + 150)
                           )
                       }//enemiesBruh
                       let buildingtr = N.filter(i => i.name == "turret" && Math.hypot((i.y - R.y), (i.x - R.x)) <= getElement("hpBuilRan").value && i.active != 0 && getElement("hpBuilRan").value);
                       for(let i = 0; i < buildingtr.length;i++) {
                           be.fillStyle=rt,
                               be.roundRect(buildingtr[i].x-f-o.healthBarWidth/2.5-o.healthBarPad,buildingtr[i].y-d-buildingtr[i].scale,2*o.healthBarWidth/2.5+2*o.healthBarPad,17,8),
                               be.fill(),
                               be.fillStyle=buildingtr[i].owner.sid==R.sid?"#8ecc51":isTeam(buildingtr[i].owner.sid)?"#9B870C":"#cc5151",
                               be.roundRect(buildingtr[i].x-f-o.healthBarWidth/2.5,buildingtr[i].y-d+o.healthBarPad-buildingtr[i].scale,2*o.healthBarWidth/2.5*(buildingtr[i].tReload/1),17-2*o.healthBarPad,7),
                               be.fill();
                       }
                       _ == R && getElement("autoWar").checked && (be.textAlign = "center",
                                                                   be.fillStyle = "#cc5151",
                                                                   be.lineJoin = "round",
                                                                   be.font = "20px Hammersmith One",
                                                                   be.lineWidth = 6,
                                                                   be.strokeText(instaIsOn,_.x - f,_.y - d),
                                                                   be.fillText(instaIsOn,_.x - f,_.y - d))
                       if(buildsB.length && getElement("blahblah").checked) {
                           for(let u = 0; u < buildsB.length; u++) {
                               be.strokeStyle = '#808080';
                               be.lineWidth = oe/640;
                               be.beginPath();
                               be.moveTo(R.x - f, R.y - d);
                               be.lineTo(buildsB[u].x - f, buildsB[u].y - d);
                               be.stroke();
                           }
                       }
                       if(getElement("hpBuilRan").value) {
                           for(let i = 0; i < N.length; i++){
                               if(N[i].group && N[i].active != 0){
                                   if(Math.hypot((N[i].y - R.y), (N[i].x - R.x)) <= getElement("hpBuilRan").value && N[i].buildhealth > 0){
                                       be.fillStyle=rt,
                       ...
                       if(instaIsOn == true && nEy.length && R.alive) {
                       ...
                       _.health > 0 && (o.healthBarWidth,
                                        ...
                                        be.fill()),
                           _.isPlayer && ((o.reloadBarWidth,
                                           be.fillStyle = rt,
                                           be.roundRect(_.x - f - o.reloadBarWidth*2 - o.healthBarPad-5, _.y - d + _.scale + o.nameY - (150 + 16), 2 * o.reloadBarWidth + 2 * o.healthBarPad, 17, 8),
                                           be.fill(),
                                           be.fillStyle = "#a5974c",
                                           be.roundRect(_.x - f - o.reloadBarWidth*2-5, _.y - d + _.scale + o.nameY + o.healthBarPad - (150 + 16), 2 * o.reloadBarWidth * ((!getElement("allRBar").checked) ? (_.weaponIndex<9)?primaryReload[_.sid]:secondaryReload[_.sid] : primaryReload[_.sid]), 17 - 2 * o.healthBarPad, 7),
                                           be.fill()))
                       getElement("allRBar").checked && _.isPlayer && (o.reloadBarWidth,
                                                                       be.fillStyle = rt,
                                                                       be.roundRect(_.x - f - o.healthBarPad+5, _.y - d + _.scale + o.nameY - (150 + 16), 2 * o.reloadBarWidth + 2 * o.healthBarPad, 17, 8),
                                                                       be.fill(),
                                                                       be.fillStyle = "#a5974c",
                                                                       be.roundRect(_.x - f+5, _.y - d + _.scale + o.nameY + o.healthBarPad - (150 + 16), 2 * o.reloadBarWidth * secondaryReload[_.sid], 17 - 2 * o.healthBarPad, 7),
                                                                       be.fill())
                   }
