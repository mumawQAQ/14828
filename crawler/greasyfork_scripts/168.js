// ==UserScript==
// @name          SHELL SHOCKERS Hacks | for more https://discord.gg/GUNx3rq6
// @namespace    https://greasyfork.org/en/scripts?q=pixxy
// @version      4.0.8
// @description  INVISIBILITY, EGG SIZE, SPEED, AIM ASSIST & LOW GRAVITY!! ENJOY YOUR OWN PERSONAL ADMIN PANEL!! | SHELL SHOCKERS Hacks | for more https://discord.gg/GUNx3rq6 (UPDATED VERSION)
// @author       pixxy
// @match        *://shellshock.io/*
// @match        *://algebra.best/*
// @match        *://algebra.vip/*
...
// @match        *://yolk.tech/*
// @match        *://zygote.cafe/*
// @icon         https://bluewizard.com/wp-content/uploads/2020/10/faces.jpg
// @grant        none
...
function espCalc(){
  ...
  for(var ply = 0; ply < players.length; ply++) {
    ...
    function datgui(){
        ...
        // Settings
        let guiSettings = gui.addFolder('pixxys Admin Panel & Private Server');
        guiSettings.add(window.settings, 'AimAssist').onChange();
        guiSettings.add(window.settings, 'ESP').onChange();
        guiSettings.open();
        guiSettings = gui.addFolder('pixxys Private Server');
